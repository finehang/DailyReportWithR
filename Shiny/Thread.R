...
tic()
cluster <- new_cluster(42) # 建立50核心的集群
...
tryCatch(
  ...
  while (T) {
    ...
    while (hour(now()) >= 9 & hour(now()) <= 18 & hour(now()) %% 1 == 0 & minute(now()) > 45) {
      ...
      # 开始获取所有账户
      message("Start to Get All Accounts, 60s are required! ")
      tic()
      while (flag & n < 8) {
        n <- n + 1
      ...
      message("Start to Deal With 183IDs, 600s are required!")
      tic()
      message(str_c("Now is ", now()))
      ...
      message("Start to Deal With 100IDs,  180s are required!")
      message(str_c("Now is ", now()))
      ...
      message("Start to Deal With 30IDs, 100s are required!")
      message(str_c("Now is ", now()))
      ...
      message("Start to Deal With 3IDs, 60s are required!")
      message(str_c("Now is ", now()))
      ...
      # 获取月度消耗 need 154s ------------------------------------------------------------------
      message("Start to Get Month Spend, 80s are required!")
      message(str_c("Now is ", now()))
      tic()
      ...
      # 获取昨日消耗 need 36s -----------------------------------------------------------------
      message("Start to Get Yesterday Spend, 50s are required!")
      message(str_c("Now is ", now()))
      tic()
      ...
      # 获取今日消耗 need 36s -----------------------------------------------------------------
      message("Start to Get Today Spend, 50s are required!")
      message(str_c("Now is ", now()))
      tic()
